...
Route::middleware(['auth', 'verified'])->group(function(){
    ...
    // Route::post('/checkout', [CheckoutComponent::class, 'storeCheckout'])->name('shop.checkout2');
...
Route::get('/checkout', CheckoutComponent::class)->name('shop.checkout')->middleware(['auth', 'verified', 'password.confirm']);
